...
class RegisterController: UIViewController, NavgationTransitionable, UITextFieldDelegate {
    ...
    @IBAction func registerButtonPressed(_ sender: UIButton) {
        ...
        FIRAuth.auth()?.createUser(withEmail: emailTextField.text!, password: passwordTextField.text!, completion: { (user, error) in
            ...
            self.performSegue(withIdentifier: "RegisterCorrect", sender: self)
            ...
            let values = ["name": self.nameTextField.text!, "email": self.emailTextField.text!, "created_at": now] as [String : Any]
