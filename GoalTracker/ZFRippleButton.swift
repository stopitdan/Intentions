...
open class ZFRippleButton: UIButton {
    ...
    @IBInspectable open var ripplePercent: Float = 0.95 {
        didSet {
            setupRippleView()
        }
    }
    
    @IBInspectable open var rippleColor: UIColor = UIColor(netHex: 0xAB2A36) {
        didSet {
    ...
    @IBInspectable open var buttonCornerRadius: Float = 6 {
        didSet{
